...
<c:if test="${postResult}">
    <div class="box" style="/*display: none;*/">
        ...
        <p style="color: red;">Odrzucono: <strong>${failCount}</strong>
            <c:if test="${failCount != '0'}"> z następujących powodów: <c:out value="${error}"></c:out></p>
        <table>
            <tbody>
...
<div class="box">
    ...
    <span style="display: block; color: red;text-align: center;"><c:out value="${error}"></c:out></span>
